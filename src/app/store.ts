// This is a simple wrapper for fixed-arity, subset-typed, non-mutating Object.assign. -- Make objects not mutable
...
export function rootReducer(state: IAppState, action): IAppState {
  switch (action.type) {
    ...
    case TOGGLE_TODO:
      ...
      // So, first we need to find the item to be modified. Here, we are finding it by it's id. -- Find the id
      var todo = state.todos.find(t => t.id === action.id);

      // Now, we need to find the position of this item in the array. -- Get position on array
      ...
      return tassign(state, {
        todos: [
          ...
          //
          // We use the spread operator (...) to enumerate an array. This is a clean way to -- spread , concat two arrays
